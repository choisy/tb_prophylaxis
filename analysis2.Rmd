...
\begin{align}
  S^*   &= \frac{(\mu + \delta_2 + \sigma_2) (\mu + \delta_1 + \sigma_1 + \tau)}
         ...
         \left[\left(1 + \frac{\rho}{\mu + \delta_3} \right) \mu + \alpha + \gamma \right]
         \frac{1}{\beta} N                                    \\
  S^*   &= (\mu + \delta_1 + \sigma_1 + \tau)\frac{A}{\beta}N \\
  D^*   &= \frac{1 - (\mu + \delta_1 + \sigma_1 + \tau) A}
                {1 + \rho / (\mu + \delta_3) + (1 + \tau / (\mu + \delta_2 + \sigma_2)) A}
           \frac{1}{\beta} N \\
  I_1^* & = \frac{\mu + \delta_2 + \sigma_2 + \tau}{\mu + \delta_2 + \sigma_2}
            \left[ N - S^* - \left( 1 + \frac{\rho}{\mu + \delta_3} \right) D^* \right] \\
  I_2^* & = N - S^* - I_1^* - \left( 1 + \frac{\rho}{\mu + \delta_3} \right) D^* \\
  I_3^* & = N - S^* - I_1^* - I_2^* - I_3^* - D^*
\end{align}
$$
...
$$
A = \frac{\mu + \delta_2 + \sigma_2}{(\mu + \delta_2 + \sigma_2) \delta_1 + \tau \delta_2}
\left[ \left( 1 + \frac{\rho}{\mu + \delta_3} \right) \mu + \alpha + \gamma \right]
$$
...
equilibium <- function(
  ...
  S <- (mu + delta2 + sigma2) * (mu + delta1 + sigma1 + tau) * 
       ((1 - rho / (mu + delta3)) * mu + alpha + gamma) * N /
       (beta * ((mu + delta2 + sigma2) * delta1 + tau * delta2))
  D <- (N - S) /
       (1 + rho / (mu + delta3)
        + (1 + tau / (mu + delta2 + sigma2)) * beta * S /
          (N * (mu + sigma1 + delta1 + tau)))
  c(S = S, D = D)
}
```
...
equilibium <- function(
  ...
  I1 <- (N - S - (1 + rho / (mu + delta3)) * D) /
        (1 + tau / (mu + delta2 + sigma2))
...
dynamics <- epidemiology(S0, I10, I20, I30, D0,
                         ...
                         gamma, tau, rho, mu, alpha, seq2(0, 100))

...
treatment policy that accounts for (i) contact tracing efficacy, (ii) the
distribution of effective treatment duration (derived from treatment uptake and
adherence) as a function of the proposed treatment duration, and (iii) treatment
efficacy as a function of the effective treatment duration. The efficacy of the
prophylactic treatment policy is then integrated into the formula of the TB
prevalence in order to derive the relationship between the proposed duration of
the prophylactic treatment and the TB prevalance in the population.

#### 1.2.1 Epidemiological sub-model
We develop a simple 5-parameters epidemiological model of TB that considers 3
clinical status (Figure 1): (i) susceptible ($S$), (ii) infected and neither sick nor
infectious ($I$), (iii) sick and infectious ($D$). In this model people can
...
the disease that do so within a given duration after infection, and (v) the
...
Each of these 2 effects is modelled by a 3-parameter Hill equation as described
above and, from these two probabilities combined, we derive the probability
distribution of the effective treatment duration among the people taking the
treatment (Figure 5). This probability distribution depends on the proposed duration of the
treatment.
...
Here we can put all the pieces together: (i) treatment uptake and (ii) effective
duration of treatment, both as function of the proposed duration of the
treatment, (iii) treatment efficiency as a function of the effective duration of
the treatment and, finally, (iv) the proportion of infected that can be found
through contact tracing. Putting these 4 components together defines the
efficacy of the prophylactic treatment strategy as a function of its proposed
duration. We then convert this efficacy into a rate of the epidemiological model
and insert this rate into the formula of the prevalence of TB that we derived
first. Once this is done, we can express the prevalence of TB directly as a
...
prophylactic treatment that minimizes the TB prevalence (Figure 7).

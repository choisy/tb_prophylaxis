...
The distribution of effective treatment duration as a function of the proposed
treatment duration is itself derived from assumptions made on how treatment
uptake and adherence depend on the proposed treatment duration.
...
clinical status (**Figure 1**): (i) susceptible ($S$), (ii) infected and neither
sick nor infectious ($I$), (iii) sick and infectious ($D$). In this model people can
